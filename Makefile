...
LIBS=-lssl -lresolv -lm  -lpthread -L/opt/local/lib -lxml2 -lz -lpthread -liconv -lm -L/usr/lib -lcrypto -lssl
CFLAGS=-D_REENTRANT=1 -I. -Igw -g -O2 -DDARWIN=1 -L/Developer/SDKs/MacOSX10.5.sdk/usr/lib -I/Developer/SDKs/MacOSX10.5.sdk/usr/include -D_LARGE_FILES= -I/opt/local/include/libxml2 -I/usr/include/openssl
LDFLAGS=
...
libgw.a: $(gwobjs)
	libtool -static -o libgw.a $(gwobjs)
	$(RANLIB) libgw.a

libgwlib.a: $(libobjs)
	libtool -static -o  libgwlib.a $(libobjs)
	$(RANLIB) libgwlib.a

libwmlscript.a: $(wmlscriptobjs)
	libtool -static -o libwmlscript.a $(wmlscriptobjs)
	$(RANLIB) libwmlscript.a

libwap.a: $(wapobjs)
	libtool -static -o libwap.a $(wapobjs)
	$(RANLIB) libwap.a
...
gw-config: utils/foobar-config.sh Makefile
	./utils/foobar-config.sh "-I$(includedir)/kannel -g -O2 -DDARWIN=1 -L/Developer/SDKs/MacOSX10.5.sdk/usr/lib -I/Developer/SDKs/MacOSX10.5.sdk/usr/include -D_LARGE_FILES= -I/opt/local/include/libxml2 -I/usr/include/openssl" \
		"-L$(libdir)/kannel -lgw -lwap -lgwlib -lssl -lresolv -lm  -lpthread -L/opt/local/lib -lxml2 -lz -lpthread -liconv -lm -L/usr/lib -lcrypto -lssl" \
		"1.4.3" > gw-config
